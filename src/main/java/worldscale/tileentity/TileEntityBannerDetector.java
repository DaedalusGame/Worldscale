...
import worldscale.util.InventoryUtil;

import java.util.List;

public class TileEntityBannerDetector extends TileEntity implements ITickable
{
    boolean powered;
    int maxdist;
    ...
    public void update()
    {
        if (!this.world.isRemote)
        {
            ...
            if (newPowered != powered)
            {
                ...
                this.world.notifyNeighborsOfStateChange(pos, state.getBlock(), true);
            }
        }
    }
    ...
    public void readFromNBT(NBTTagCompound compound) {
        ...
        InventoryUtil.readInventoryFromCompound(compound.getCompoundTag("inventory"), bannerInventory);
    }
